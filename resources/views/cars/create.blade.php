<x-guest-layout>
    <form method="POST" action="{{ route('cars.store') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="license_plate" class="block mt-1 w-full" type="text" name="license_plate" :value="old('license_plate')" required autocomplete="license_plate" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="rental_rate" class="block mt-1 w-full" type="text" name="rental_rate" :value="old('rental_rate')" required autocomplete="rental_rate" />
            <x-input-error :messages="$errors->get('rental_rate')" class="mt-2" />
        </div>

        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('cars.index') }}">
                {{ __('Cancel') }}
            </a>
